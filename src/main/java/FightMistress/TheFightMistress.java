...
import FightMistress.cards.*;
import FightMistress.cards.interfaces.SkillAnimationAttack;
import FightMistress.relics.DemonSoul;
import FightMistress.ui.BetterCustomEnergyOrb;
...
import static FightMistress.MainModfile.*;

public class TheFightMistress extends CustomPlayer {
    ...
    static final String ID = makeID(TheFightMistress.class.getSimpleName());
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheFightMistress(String name, PlayerClass setClass) {
    ...
    public AbstractCard.CardColor getCardColor() {
        return Enums.MISTRESS_CARMINE_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return MainModfile.MISTRESS_CARMINE_COLOR.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheFightMistress(name, chosenClass);
    }
    ...
    public Texture getCutsceneBg() {
        return ImageMaster.loadImage("FightMistressResources/images/panels/bkg.png");
    }

    @Override
    public List<CutscenePanel> getCutscenePanels() {
        List<CutscenePanel> panels = new ArrayList<>();
        panels.add(new CutscenePanel("FightMistressResources/images/panels/HeartPanel.png", "UNLOCK_PING"));
        return panels;
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_FIGHT_MISTRESS;
        @SpireEnum(name = "MISTRESS_CARMINE_COLOR")
        public static AbstractCard.CardColor MISTRESS_CARMINE_COLOR;
        @SpireEnum(name = "MISTRESS_CARMINE_COLOR")
