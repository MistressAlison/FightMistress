...
import FightMistress.util.TextureSniper;
import FightMistress.util.Wiz;
import FightMistress.vfx.VFXContainer;
...
public class TransportCannonAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        for (AbstractCard c : Wiz.adp().hand.group) {
            addToTop(new VFXAction(VFXContainer.throwEffect(TextureSniper.snipeCard(c), 0.25f, target.hb, MainModfile.MISTRESS_CARMINE_COLOR, true, false)));
        }
