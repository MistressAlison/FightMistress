package FightMistress;

import FightMistress.cardmods.AbstractInfusion;
import FightMistress.cards.cardvars.*;
...
public class MainModfile implements
    ...
    public static final Color MISTRESS_CARMINE_COLOR = CardHelper.getColor(226, 102, 128); //E26680
    ...
    public static final String ATTACK_S_ART = modID + "Resources/images/512/attack_tree.png";
    public static final String SKILL_S_ART = modID + "Resources/images/512/skill_tree.png";
    public static final String POWER_S_ART = modID + "Resources/images/512/power_tree.png";
    public static final String ATTACK_L_ART = modID + "Resources/images/1024/attack_tree.png";
    public static final String SKILL_L_ART = modID + "Resources/images/1024/skill_tree.png";
    public static final String POWER_L_ART = modID + "Resources/images/1024/power_tree.png";
    ...
    public MainModfile() {
        ...
        BaseMod.addColor(TheFightMistress.Enums.MISTRESS_CARMINE_COLOR, MISTRESS_CARMINE_COLOR, MISTRESS_CARMINE_COLOR, MISTRESS_CARMINE_COLOR,
                MISTRESS_CARMINE_COLOR, MISTRESS_CARMINE_COLOR, MISTRESS_CARMINE_COLOR, MISTRESS_CARMINE_COLOR,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheFightMistress(TheFightMistress.characterStrings.NAMES[1], TheFightMistress.Enums.THE_FIGHT_MISTRESS),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheFightMistress.Enums.THE_FIGHT_MISTRESS);
