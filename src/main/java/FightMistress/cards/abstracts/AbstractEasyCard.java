package FightMistress.cards.abstracts;

import FightMistress.MainModfile;
import FightMistress.TheFightMistress;
import FightMistress.util.CardArtRoller;
...
import static FightMistress.MainModfile.makeImagePath;
import static FightMistress.MainModfile.modID;
import static FightMistress.util.Wiz.atb;
import static FightMistress.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheFightMistress.Enums.MISTRESS_CARMINE_COLOR);
    }
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        FlavorText.AbstractCardFlavorFields.boxColor.set(this, mix(BLACK.cpy(), MainModfile.MISTRESS_CARMINE_COLOR.cpy()));
