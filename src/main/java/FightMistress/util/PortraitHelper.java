...
public class PortraitHelper {
    ...
    private static final Texture attackMask = TexLoader.getTexture("FightMistressResources/images/masks/AttackMask.png");
    private static final Texture skillMask = TexLoader.getTexture("FightMistressResources/images/masks/SkillMask.png");
    private static final Texture powerMask = TexLoader.getTexture("FightMistressResources/images/masks/PowerMask.png");
