...
import FightMistress.actions.InfusionTriggerAction;
import FightMistress.cards.cardvars.DynvarInterfaceManager;
import FightMistress.util.TextureScaler;
        ...
        Wiz.atb(new AbstractGameAction() {
            ...
            public void update() {
                ...
                if (mon!= null) {
                    ...
                    Wiz.att(new InfusionTriggerAction(DealRandomDamageMod.this, damage, baseVal == relicStatsVal ? damage : damage - FightMistress.util.CalcHelper.calculateCardDamage(baseVal - relicStatsVal, mon)));
                }
                this.isDone = true;
            }
        });
